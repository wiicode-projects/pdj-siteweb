...
const fr: AppTranslations = {
  ...
  pricing: {
    ...
    demoDesc: 'Découvrez la plateforme avec votre établissement — vos plats et votre menu sont conservés lors du passage à un abonnement payant.',
    demoFeatures: [
      'Accès complet au back-office',
      'Création de plats et prévisualisation du menu',
      'Publication bloquée jusqu\'à souscription',
    ],
    ctaDemo: 'Découvrir en démo',
...
const en: AppTranslations = {
  ...
  pricing: {
    ...
    demoDesc: 'Discover the platform with your restaurant — your dishes and menu preview are kept when you upgrade to a paid plan.',
    demoFeatures: [
      'Full back-office access',
      'Create dishes and preview your menu',
      'Publishing blocked until subscription',
    ],
    ctaDemo: 'Discover in demo',
...
const de: AppTranslations = {
  ...
  pricing: {
    ...
    demoBadge: 'Demo',
    demoTitle: 'Demonstrationsmodus',
    demoDesc: 'Entdecken Sie die Plattform mit Ihrem Restaurant — Gerichte und Menüvorschau bleiben beim Upgrade erhalten.',
    demoFeatures: [
      'Voller Backoffice-Zugang',
      'Gerichte erstellen und Menüvorschau',
      'Veröffentlichung erst nach Abo',
    ],
    ctaDemo: 'Demo entdecken',
...
const it: AppTranslations = {
  ...
  pricing: {
    ...
    demoBadge: 'Demo',
    demoTitle: 'Modalità dimostrazione',
    demoDesc: 'Scopri la piattaforma con il tuo ristorante — piatti e anteprima menu restano al passaggio a un abbonamento.',
    demoFeatures: [
      'Accesso completo al back-office',
      'Creazione piatti e anteprima menu',
      'Pubblicazione bloccata fino all\'abbonamento',
    ],
    ctaDemo: 'Scopri in demo',
